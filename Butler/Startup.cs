...
namespace Butler
{
    public class Startup
    {
        ...
        {
            Scope = "Butler", //The name of the scope for api access
            DisplayName = "Butler", //Change this to a pretty name for the client/resource
            ClientId = "Butler", //Change this to a unique client id
